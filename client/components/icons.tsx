// Inline SVG icon components shared across the sidebar and toolbar. Extracted
// from Sidebar.tsx; markup is unchanged.
...
// Antigravity ("agy"). The brand mark is a multi-layer blurred/colored SVG, so
// we render it from the public asset instead of inlining the heavy markup (it is
// drawn once per session/dir row, and inline filter IDs would collide).
export const AgyIcon = () => (
  <img
...
// Grok. The source mark is solid black; inline it with currentColor so it stays
// visible (and follows hover/active tint) on the dark sidebar, like CodexIcon.
export const GrokIcon = () => (
  <svg height="11" width="11" viewBox="0 0 1024 1024" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
export const CaretIcon = ({ open }: { open: boolean }) => (
  <svg
    width="7"
    height="7"
    viewBox="0 0 8 8"
